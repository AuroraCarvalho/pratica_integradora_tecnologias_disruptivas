...
const initialRows = [
  createData(1, 'Tarefa 1', 'Fazer aula pratica', '2022-01-01', '2022-01-02', 'Concluída', 'Recurso 1'),
  createData(2, 'Tarefa 2', 'Publicar no git', '2022-01-03', '2022-01-04', 'Em Andamento', 'Recurso 2'),
  createData(3, 'Tarefa 3', 'Enviar tarefa', '2022-01-04', '2022-01-05', 'Concluída', 'Recurso 3'),
  createData(4, 'Tarefa 4', 'Gratidão', '2022-01-05', '2022-01-06', 'Em Andamento', 'Recurso 4'),
  createData(5, 'Tarefa 5', 'Gratiluz', '2022-01-06', '2022-01-07', 'Em Andamento', 'Recurso 5'),
  createData(6, 'Tarefa 6', 'lhamaste', '2022-01-07', '2022-01-08', 'Aguardando', 'Recurso 6'),
];
...
const ListarTarefa = () => {
  ...
  const handleDeletar = (id) => {
    ...
    <Card>
        <CardHeader
          title="Lista de aula pratica Aurora"
